      ...
      <div class="portlet-body">
        ...
        <div class="box-body">                   
          ...
          <form id="data_form" action="" method="post">
            <div class="box-body">
              <label><h3><b>Detail Jadwal Barang Datang</b></h3></label>
              <div class="row">
                <div class="col-md-6">
                  ...
                  $transaksi_po = $this->db->get_where('transaksi_po',array('kode_transaksi'=>$kode));
            ...
            <div id="list_transaksi_pembelian">
              <div class="box-body">
                <table id="tabel_daftar" class="table table-bordered table-striped" style="font-size:1.5em;">
                  ...
                  <tbody id="tabel_temp_datatransaksi">
                    <?php
                    $kode = $hasil_transaksi_po->kode_po;
...
<script>
  function reload_table(){
    $('#tabel_temp_data_transaksi').load('<?php echo base_url().'jadwal_barang_datang/tabel_belum_datang/'.$jvalidasi.'/'.$kode; ?>')
  }
