...
<div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light red-soft"  id="validasi">
    <div class="visual">
      <i class="glyphicon glyphicon-tasks" ></i>
    </div>
    <div class="details">
      <div class="number">
        <?php
        $po = $this->db->query('SELECT * FROM transaksi_pembelian WHERE status="belum divalidasi" OR status="belum divalidasi2"');
        $hasil_po = $po->num_rows();
        if($hasil_po > 0){
        	echo $hasil_po;
        }
...
<div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light blue-steel" id="jadwal_barang">
    <div class="visual">
      <i class="glyphicon glyphicon-tasks" ></i>
    </div>
    <div class="details">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#jadwal_barang").click(function(){
     $('.tunggu').show();
     window.location = "<?php echo base_url() . 'jadwal_barang_datang/daftar_jadwal' ?>";
   });
