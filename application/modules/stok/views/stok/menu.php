	...
	<div class="page-content">
		...
		<div class="box-footer clearfix">
			...
			<div class="row">
				...
				<!-- <div class="col-md-3">
					<a class="dashboard-stat dashboard-stat-light red-soft" href="<?php echo base_url().'stok/daftar_stok_min'?>" id="stok_min">
						<div class="visual">
				...
				<!--<div class="col-md-3">
					<a class="dashboard-stat dashboard-stat-light yellow-casablanca" href="<?php echo base_url().'repack/daftar_repack' ?>" id="daftar_jenis">
						<div class="visual">
