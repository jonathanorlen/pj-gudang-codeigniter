                ...
                <div class="box box-info">
                    ...
                    <div class="sukses" ></div>
                        <form id="data_form" action="" method="post">
                            <div class="box-body">
                              <label><h3><b>Tambah Spoil</b></h3></label>
                              <div class="row">
                                <?php
                                    $tgl = date("Y-m-d");
                                    $no_belakang = 0;
...
$(document).ready(function(){
  ...
  $("#update").hide();
  $("#tabel_temp_data_transaksi").load("<?php echo base_url().'stok/stok/get_spoil'; ?>");
  ...
  $("#data_form").submit(function(){
          var simpan_spoil = "<?php echo base_url().'stok/stok/simpan_spoil'?>";
          $.ajax({
              type: "POST",
              url: simpan_spoil,
              ...
              success: function(msg)
              {
                ...
                setTimeout(function(){$('.sukses').html('');
                  window.location = "<?php echo base_url() . 'stok/daftar_spoil/'.$item['kode_unit'] ; ?>";
                },1500);        
              }
          });
          return false;
...
function add_item(){
      ...
      var url = "<?php echo base_url().'stok/stok/simpan_item_temp'?> ";
...
function actEdit(id) {
  var id = id;
  var url = "<?php echo base_url().'stok/stok/get_temp_spoil'; ?>";
  $.ajax({
    type: 'POST',
    url: url,
    dataType: 'json',
...
function update_item(){
    ...
    var url = "<?php echo base_url().'stok/stok/update_item_temp/'.$kode_unit; ?> ";
...
function delData() {
    ...
    var url = '<?php echo base_url().'stok/stok/hapus_bahan_temp'; ?>/delete';
    $.ajax({
        type: "POST",
        url: url,
        data: {
