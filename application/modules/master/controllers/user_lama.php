...
class user extends MY_Controller {
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/user', $data, TRUE);
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/coba', $data, TRUE);
		$data['halaman'] = $this->load->view('user/menu', $data, TRUE);
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/daftar', $data, TRUE);
		$data['halaman'] = $this->load->view('user/menu', $data, TRUE);
		$this->load->view('main', $data);	
	}
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/form', $data, TRUE);
		$data['halaman'] = $this->load->view('user/menu', $data, TRUE);
		$this->load->view('user/main', $data);		
	}
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/form_ubah', $data, TRUE);
		$data['halaman'] = $this->load->view('user/menu', $data, TRUE);
		$this->load->view('user/main', $data);		
	}
	...
	{
		$data['aktif'] = 'user';
		$data['konten'] = $this->load->view('user/detail', $data, TRUE);
		$data['halaman'] = $this->load->view('user/menu', $data, TRUE);
		$this->load->view('user/main', $data);			
	}
