            ...
            <div class="form-group">
              <div class="col-md-12">
                ...
                <select class="form-control" name="keanggotaan" required>              
                  <option <?php if(@$hasil_ambil_data->keanggotaan=='calon_anggota') {echo 'selected';} ?>
                    value="calon_anggota"    
                    >
                    Calon Anggota
                  </option>
                  <option <?php if(@$hasil_ambil_data->keanggotaan=='anggota') {echo 'selected';} ?>
                    value="anggota"    
                    >
                    Anggota
                  </option>
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        ...
        if(empty($hasil_ambil_data)){
          ...
          ?>
          url : "<?php echo base_url() . 'anggota/simpan_ubah' ?>",  
          <?php
        }
        ?>
        cache :false,  
