...
$(".tunggu").show();
            window.location = "<?php echo base_url().'retur_stok/daftar_retur_stok'; ?>";
          });
        </script>
  <div class="col-xs-12">
    <!-- /.box -->
    <div class="portlet box blue">
      ...
      <div class="portlet-body">
        ...
        <a style="padding:13px; margin-bottom:10px;" class="btn btn-app blue" href="<?php echo base_url() . 'retur_stokr/daftar_retur_stok' ?>"><i class="fa fa-list"></i> Daftar </a> 
        ...
        <div class="box-body">                   
          ...
          <form id="data_form" action="" method="post">
            <div class="box-body">
              <label><h3><b>Retur Stok</b></h3></label>
              <div class="row">
                <div class="col-md-6">
           ...
           <div class="gagal" ></div>
           <div class="box-body">
            <label><h3><b>Item Retur Stok</b></h3></label>
            <div class="row">
              <div class="col-md-12">
                <!-- <div class="col-md-2">
              ...
              <input type="hidden" name="kategori_bahan" id="kategori_bahan" />
              <div class="col-md-2">
            ...
            <div id="edit_hide" class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  $supplier = $supplier->result();
                  ?>
                  <select class="form-control" name="kode_supplier_awal" id="kode_supplier_awal" >
                   <option selected="true" value="">--Pilih Supplier--</option>
                   <?php foreach($supplier as $daftar){ ?>
                   <option value="<?php echo $daftar->kode_supplier ?>"><?php echo $daftar->nama_supplier ?></option>
                   <?php } ?>
...
$(document).ready(function(){
  ...
  $("#cari_nota").submit(function(){
    var cari_nota = "<?php echo base_url().'retur_stok/cari_nota/'?>";
      ...
      success: function(msg)
      {
        ...
        var nota = data[1];
                ...
                if(num > 0){  
                  ...
                  $('#tabel_temp_data_retur').load("<?php echo base_url().'retur_stok/tabel_item_retur/'; ?>"+kode_retur);
...
$("#kategori_bahan").change(function(){
  ...
  var url = "<?php echo base_url().'retur_stok/get_bahan'; ?>";
  $.ajax({
    type: "POST",
    url: url,
...
$('#kode_bahan').on('change',function(){
  ...
  var url = "<?php echo base_url() . 'retur_stok/get_satuan' ?>";
  $.ajax({
    type: 'POST',
    url: url,
    dataType:'json',
...
$("#data_form").submit(function(){
  var simpan_retur = "<?php echo base_url().'retur_stok/simpan_retur/'?>";
  $.ajax({
    type: "POST",
    url: simpan_retur,
...
function add_item(){
  ...
  var url = "<?php echo base_url().'retur_stok/simpan_item_retur_temp/'?> ";
...
function delData() {
  ...
  var kode_retur = $('#kode_retur').val();
  var url = "<?php echo base_url().'retur_stok/hapus_temp'; ?>";
  $.ajax({
    type: 'POST',
    url: url,
    data: {id:id},
...
function actEdit(id) {
  var id = id;
  var url = "<?php echo base_url().'retur_stok/get_temp_retur'; ?>";
  var kode_retur = $('#kode_retur').val();
  $.ajax({
    type: 'POST',
    url: url,
...
function update_item(){
  ...
  var url = "<?php echo base_url().'retur_stok/ubah_item_retur_temp/'?> ";
