...
class retur_stok extends MY_Controller {
    ...
    public function daftar_retur_stok()
    {
        ...
        $data['konten'] = $this->load->view('retur_stok/retur/daftar_retur_stok', NULL, TRUE);
    ...
    {
        $data['aktif']='retur_stok';
        $data['konten'] = $this->load->view('retur_stok/retur/tambah_retur_stok', NULL, TRUE);
        $data['halaman'] = $this->load->view('menu', $data, TRUE);
        $this->load->view('main', $data);       
    }
