  ...
  <div class="col-xs-12">
    ...
    <div class="portlet box blue">
      ...
      <div class="portlet-body">
        ...
        <a style="padding:13px; margin-bottom:10px;" class="btn btn-app green" href="<?php echo base_url() . 'repack/tambah_repack' ?>"><i class="fa fa-edit"></i> Tambah </a>
      <!-- <a style="padding:13px; margin-bottom:10px;" class="btn btn-app blue" href="<?php echo base_url() . 'repack/daftar_repack' ?>"><i class="fa fa-list"></i> Daftar </a> -->
        <div class="box-body">            
          ...
          <table class="table table-striped table-hover table-bordered" id="tabel_daftar"  style="font-size:1.5em;">
            ...
            $repack = $this->db->get('opsi_transaksi_mutasi');
            ...
            <tbody>
              ...
              foreach($hasil_repack as $daftar){ 
               $query = $this->db->query(" SELECT * FROM transaksi_stok where kode_transaksi= '$daftar->kode_repack' and kode_unit_asal='$kode_unit' ");
               $cek=$query->num_rows();
               $petugas=$query->row();
               if($cek>0){
                            //echo "$kode_unit";
                ...
                <tr>
                  ...
                  <td align="center"><?php echo get_detail_repack($daftar->kode_repack); ?></td>
                </tr>
                <?php $nomor++; }} ?>
...
<script type="text/javascript">
  ...
  $('#cari').click(function(){
    ...
    $.ajax( {  
        type :"post",  
        url : "<?php echo base_url().'repack/cari_repack'; ?>",  
        cache :false,
