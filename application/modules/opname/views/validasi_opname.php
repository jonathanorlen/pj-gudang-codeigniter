                  ...
                  <tbody>
                    ...
                    foreach($list_opname as $daftar){ 
                      ...
                      <tr>
                        ...
                        <td><?php echo format_rupiah($daftar->selisih * $hasil_satuan->hpp); ?></td>
                        <td><a bb="<?php echo $kode_bahan ?>" op="<?php echo $daftar->kode_opname; ?>" class="btn btn-md btn-warning hapus"><i class="fa fa-trash"></i> Delete</a></td>
...
function delData(){
  ...
  var url = "<?php echo base_url().'opname/opname/hapus_opsi_opname'?>";
   $.ajax({
      type: "POST",
      url: url,
...
$(document).ready(function(){
  ...
  $('#simpan').on('click',function(){
    ...
    var url = "<?php echo base_url().'opname/opname/sesuaikan'?>";
    var form_data = {
      kode_opname: kode_opname,
...
$('#dihibahkan').on('click',function(){
    var kode_opname = $('#kode_opname').val();
    var url = "<?php echo base_url().'opname/opname/dihibahkan'?>";
    var form_data = {
      kode_opname: kode_opname
    };
    $.ajax({
